...
namespace Floreil_PHP_MVC;

use Floreil_PHP_MVC\Engine as E;
...
try
{
    ...
    $aParams = ['ctrl' => (!empty($_GET['p']) ? $_GET['p'] : 'floreil'), 'act' => (!empty($_GET['a']) ? $_GET['a'] : 'index')]; // si p est vide : p=blog, si a est vide : a=index
